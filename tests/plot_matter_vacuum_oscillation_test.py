...
data1 = np.loadtxt("/home/erickurquilla1999/Documents/physics/thesis/my_neutrino_program/my_neutrino_program/tests/matter_vacuum_oscillation_theorical_data.txt", unpack = True, skiprows=1)	
time_teo=data1[0]
rho11_teo=data1[1]
...
plt.legend([r"$\rho_{11}^{num}$",r"$\rho_{11}^{theo}$"])
plt.show()
